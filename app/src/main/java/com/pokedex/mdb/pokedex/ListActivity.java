...
public class ListActivity extends AppCompatActivity {
    ...
    public void updateRecyclerView(ArrayList<Pokedex.Pokemon> p) {
        if (isLinear) {
            ...
            if(menu != null) menu.findItem(R.id.action_switch_layout).setIcon(ResourcesCompat.getDrawable(getResources(), R.drawable.ic_apps_black_24dp, null));
        } else {
            recycleboy.setLayoutManager(new GridLayoutManager(this, 2));
            if(menu != null) menu.findItem(R.id.action_switch_layout).setIcon(ResourcesCompat.getDrawable(getResources(), R.drawable.ic_menu_black_24dp, null));
        }
